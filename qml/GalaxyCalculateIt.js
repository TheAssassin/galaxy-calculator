...
function calc(myTableModel)
{
    ...
    if (Js.getIsDebugMessage()) console.debug("########### calc finished ############################")
} // end calc
/* ****************************************************************************
 *
 */
