...
this is a Qt Quick QML App, that will run on Desktop.
...
I will try to make installers and executables for all supported Qt OS's, currently I have:
...
If you do not see your OS, just download, extract to a folder, and open with Qt Creator, which must be installed,
and compile or run it.

TableView for Qt version greater than or equal to 5.12, still has a lot of work, as a result, it does not like a few things,
